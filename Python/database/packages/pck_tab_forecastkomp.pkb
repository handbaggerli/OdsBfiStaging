create or replace package body pck_tab_forecastkomp is
  ...
  -- Template:    :  Generell - pck_tab_forecastkomp.pks
  -- Autor        :  MMe
  ...
  -- HeadURL      :  $HeadURL: http://10.10.10.66/svn/DWH_Repository/trunk/DWH_ALLGEMEIN/SYRIUS_R3_DWH/OdsBfiStaging/database/packages/pck_tab_forecastkomp.pkb $
  --
  -- Aenderungsnachweis :
